      ...
      for (const material of data.data) {
        if (material.raw_material) {
          try {
            ...
            const rawMaterialId =
              material.raw_material._id || material.raw_material;
        ...
        <div className="flex justify-between items-center mb-8 relative z-10">
          <div>
            ...
            <p className="text-[#ababab] mt-2">
              View your raw materials stock and availability
            </p>
          </div>
        </div>
...
export default StaffInventoryMaterials;
